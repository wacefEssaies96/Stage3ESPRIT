...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="page-content">
            ...
            <nav>
                <div class="leftSide">
                    <a href=" {{ route('home') }} " class="menu-item"><img id="ppp90Lg" src="{{ asset('images/logo.png') }}" alt="PPP 90" srcset=""></a>
                ...
                <div class="rightSide">
                    ...
                    @guest
                        <a href="{{ route('login') }}" class="menu-item bgeff" style="border-right: white 1px solid"><span class="fa">&#xf2c0;</span></a>
                        <a href="" class="menu-item"><span class="fa">&#xf29c;</span></a>
                        <button><a href="{{ route('login') }}" class="menu-item">se connecter</a></button>
                    @else
                        <a href="{{ route('user.show', Auth::user()->id) }}" class="menu-item bgeff" style="border-right: white 1px solid"><span class="fa">&#xf2c0;</span></a>
                        <a href="" class="menu-item"><span class="fa">&#xf29c;</span></a>
            ...
            <footer>
                <div class="info">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="white" class="bi bi-lightbulb" viewBox="0 0 16 16">
                        <path d="M2 6a6 6 0 1 1 10.174 4.31c-.203.196-.359.4-.453.619l-.762 1.769A.5.5 0 0 1 10.5 13a.5.5 0 0 1 0 1 .5.5 0 0 1 0 1l-.224.447a1 1 0 0 1-.894.553H6.618a1 1 0 0 1-.894-.553L5.5 15a.5.5 0 0 1 0-1 .5.5 0 0 1 0-1 .5.5 0 0 1-.46-.302l-.761-1.77a1.964 1.964 0 0 0-.453-.618A5.984 5.984 0 0 1 2 6zm6-5a5 5 0 0 0-3.479 8.592c.263.254.514.564.676.941L5.83 12h4.342l.632-1.467c.162-.377.413-.687.676-.941A5 5 0 0 0 8 1z"/>
                    </svg>
                    <div>
                        <p id="infoContent">Vous êtes celui qui détient les clés de votre destin. Il vous suffit de vous lancer !</p>
                    </div>
                </div>
