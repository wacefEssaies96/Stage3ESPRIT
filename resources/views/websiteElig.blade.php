        ...
        <div class="right-side">
            ...
            <div class="right-sideP1">
                ...
                <div class="right-side-content">
                    @for ($i = 1; $i <= 30; $i++)
                        <div class="question" data-aos="fade-right" data-aos-offset="300"
                            data-aos-easing="ease-in-sine">
                            <div class="question-id">Q.{{ $i }}</div>
                            <div class="question-content">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                Corporis porro labore commodi nesciunt asperiores consectetur ut atque ipsam ullam omnis
                                placeat minus, dicta incidunt provident beatae debitis, corrupti quaerat unde.</div>
