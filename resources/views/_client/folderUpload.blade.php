...
<body>
            ...
            <div class="right-side-content slideshow-container">
                <form id="req" method="post" action=" {{ route('dossier.store', Auth::user()->id) }} "
                    ...
                    <div class="form slides fade">
                        ...
                        {{-- ====================================== **1** =============================== --}}
                        <div class="field">
                            <input class="data" type="text" name="proTitle" required />
                            @error('proTitle')
                        ...
                        {{-- ======================================= **2** ============================== --}}
                        <div class="field">
                            <input class="data" type="text" name="proImp" required />
                            @error('proImp')
                                <span class="invalid-feedback" role="alert" style="color: red">
                                    <i>{{ $message }}</i>
                                </span>
                            @enderror
                            <label for="input" alt="L’implantation du projet"
                                placeholder="Ce champ est obligatoire"></label>
                        </div>
                        {{-- ======================================= **3** ============================== --}}
                        <div class="field">
                            <input class="data" type="text" name="proDesc" required />
                            @error('proDesc')
                                <span class="invalid-feedback" role="alert" style="color: red">
                                    <i>{{ $message }}</i>
                                </span>
                            @enderror
                            <label for="input" alt="Descriptif des activités et produits"
                                placeholder="Ce champ est obligatoire"></label>
                        </div>
                        {{-- ======================================= **4** ============================== --}}
                        <div class="field">
                            <input class="data" type="text" name="proInteg" required />
                            @error('proInteg')
                                <span class="invalid-feedback" role="alert" style="color: red">
                                    <i>{{ $message }}</i>
                                </span>
                            @enderror
                            <label for="input" alt="Dans quelles industries s’intègre le projet ?"
                                placeholder="Ce champ est obligatoire"></label>
                        </div>
                        {{-- ======================================== **5** ============================= --}}
                        <div class="field">
                            <input class="data" type="text" name="proTech" required />
                            @error('proTech')
                                <span class="invalid-feedback" role="alert" style="color: red">
                                    <i>{{ $message }}</i>
                                </span>
                            @enderror
                            <label for="input" alt="Quel type de technologie utilisée dans le projet ?"
                                placeholder="Ce champ est obligatoire"></label>
                        </div>
                        <div class="btns">
                            <button type="button" id="suivant" class="btn2"
                    ...
                    <div class="attachment slides fade">
                        ...
                        <div class="icon">
                            <img id="preview" src="{{ asset('images/upload-file.png') }}" alt="NO IMAGE">
                        </div>
                        <div class="addBtn">
                        ...
                        <div class="btns">
                            ...
                            <button class="btn1">Enregistrer</button>
                            @if (isset($success))
                                <button class="btn2" type="button"
                                    onclick="window.location='{{ route('sendProjectToADMIN', [Auth::user()->id, $proTitle]) }}'">Sauvegarder</button>
                            @endif
                        </div>
                    </div>
                </form>
    ...
    @isset($success)
        <script>
            updateRequestCondition('{{ $proTitle }}')
        </script>
        <script>
            modifyInputs()
        </script>
