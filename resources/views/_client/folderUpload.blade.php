...
{{-- ********************************************** Right Side ******************************************************* --}}
        <div class="right-side">
            ...
            <div class="right-side-content slideshow-container">
                <form id="req" method="post" action=" {{ route('uploadF', Auth::user()->id) }} " enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="attachment slides fade">
                        ...
                        <div class="addBtn">
                            <button class="trigger">
                                ...
                                <input id="uploadedFiles" type="file" name="file" onchange="displayPreview(event)">
                            </button>
                        </div>
                        <div class="btns">
                            ...
                            @if (isset($success))
                                <button class="btn2" type="button" onclick="window.location='{{ route('sendProjectToADMIN', [Auth::user()->id, $proTitle]) }}'">Sauvegarder</button>
                            @endif
                        </div>
                    </div>
                </form>
...
{{-- ***************************************************************************************************************** --}}
    ...
    @isset($success)
        <script>updateRequestCondition('{{$proTitle}}')</script>
        <script>modifyInputs()</script>
    @endisset
    <script>
        beginSlide();
    </script>
