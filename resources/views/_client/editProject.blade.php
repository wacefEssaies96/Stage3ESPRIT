    ...
    <div class="page-content">
        ...
        <div class="right-side">
            ...
            <div class="right-side-content slideshow-container">
                <form id="req" method="post" action=" {{ route('dossier.update') }} "
