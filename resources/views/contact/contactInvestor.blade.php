    ...
    <div class="container-contact100">
        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" autocomplete="off" method="POST"
                action="{{ route('contact.investor.send') }}">
                @csrf
                <span class="contact100-form-title">
                    Contacter {{$investor->name}}
                </span>
                <input type="email" name="email" hidden style="display: none;" value="{{$investor->email}}">
                <div class="wrap-input100 validate-input" data-validate="Le message ne doit pas etre vide">
                    <span class="label-input100">Message</span>
                    <textarea required class="input100" name="body" placeholder="Votre message ici..."></textarea>
