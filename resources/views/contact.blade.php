    ...
    <div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" autocomplete="off">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "L'e-mail est obligatoire: ex@abc.xyz">
            ...
            <span class="fa fa-home" style="padding-left: 5%; padding-right: 5%">
                <a style="text-decoration-line: none; font-family: Poppins-Medium; color: #FCB918" href="{{ route('home') }}">Page d'acceuil</a>
            </span>
			<span class="contact100-more">
				Vous pouvez poser vos questions à nos responsables: <span class="contact100-more-highlight">+216 00 000 000</span>
			</span>
		</div>
	</div>
